...
class Comment extends AbstractComment{
    ...
    public static function getCommentByArticleId($article_id){
        $sql = 'SELECT Article_comments.comment_id , Article_comments.comment_text, Article_comments.comment_date, Users.user_name, Users.user_email 
        FROM Article_comments 
        INNER JOIN Users ON Article_comments.user_id = Users.user_id 
